...
public class ReputationAmountConfig implements ConfigObject {	
	...
	@UnionConfig.Entry(name = "Defend From Raid", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Max Out Trade", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Opening Chests or Barrels", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Bribing Villagers", side = ConfigSide.Shared)
	@UnionConfig.Comment(comment = {"How much reputation is gained or lost for failing to bribe a villager"})
	public int bribe_fail = -1;
	
	@UnionConfig.Entry(name = "Sleeping In Village Beds", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Kick Villager Out Of Bed", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Waystones", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Melons", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Pumpkins", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Bells", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Job Sites", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Rich Soil", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Organic Compost", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Flower Pots", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Torches And Lanterns", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(group = "Breaking Stuff", name = "Hay Bales", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Breaking Crops", side = ConfigSide.Shared)
	...
	@UnionConfig.Entry(name = "Breaking Beds", side = ConfigSide.Shared)
